...
def display_verified_types_view(request,s_type=None):
    ...
    if "GET" == request.method:
        ...
        if s_type != None:
            ...
            return render(request,'display_verified_types.html',context)

        else:
            return render(request,'display_verified_types.html',context)

def display_unverified_types_view(request,s_type=None):
    ...
    if "GET" == request.method:
        ...
        if s_type != None:
            ...
            return render(request,'display_unverified_types.html',context)
